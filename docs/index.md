...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/audio-to-text-gitlab-test123](https://github.com/rhdh-JslYoon-org/audio-to-text-gitlab-test123)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/audio-to-text-gitlab-test123-gitops](https://github.com/rhdh-JslYoon-org/audio-to-text-gitlab-test123-gitops)

# **Usage**

To access the audio-to-text-gitlab-test123 application that was deployed using the Software Template, complete the following instructions:
