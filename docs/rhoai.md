...
3) Access the `workbench` named `audio-to-text-gitlab-test123-notebook`.
...
5) In the terminal, run `cd audio-to-text-gitlab-test123` to navigate to your sample app's directory.
